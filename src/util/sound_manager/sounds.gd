...
# GENERAL SFX
const FOOTSTEP: StringName = "res://src/sound/footstep.wav"
const SWORD_SWOOSH: StringName = "res://src/sound/sword_swoosh.wav"
const BUSH_SLICED: StringName = "res://src/sound/bush_sliced.wav"
const GAIN_ITEM: StringName = "res://src/sound/gain_item.wav"
const DELIVER_INGREDIENT: StringName = "res://src/sound/Gain_Item_02.mp3"
const BOX_BROKEN: StringName = "res://src/sound/box_broken.wav"
const BOX_MOVING: StringName = "res://src/sound/Box Moving.wav"
const BUMP_WALL: StringName = "res://src/sound/Bump Wall.mp3"
